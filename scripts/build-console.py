...
ROWS = [
    ...
    ('thanks', 'Спасибо (страница после оплаты)', '/thanks', 'core',
     'Адрес страницы впиши как Success URL в настройках корзины/ЮKassa — иначе после оплаты останется стандартная страница ЮKassa'),
    ...
    ('project-postoim-presentation', '03 · Презентация', '/postoim_presentation', 'proj', ''),
